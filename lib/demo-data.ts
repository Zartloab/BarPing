...
export const demoTables: EventTable[] = [
  {
    id: "table-music",
    name: "The B-Side",
    description: "Songs that deserve a witness.",
    maxMembers: 10,
    memberCount: 6,
    prompt: "A song that only you know is a 10/10. What is it?",
    suggestedTopics: ["Music", "Film"],
    isSpotlighted: true,
    isActive: true,
    energyLevel: "Active",
    hostPrompt: "What song would save this room right now?",
    isTemplateGenerated: true
  },
  {
    id: "table-last-round",
    name: "Last Round",
    description: "Orders, exits, and bold claims.",
    maxMembers: 8,
    memberCount: 5,
    prompt: "What's your go-to order when you're trying to impress someone?",
    suggestedTopics: ["Food", "Life", "Random"],
    isActive: true,
    energyLevel: "Warming up",
    hostPrompt: "Best bad conversation starter: worst taxi story, fake band name, or regrettable drink?",
    isTemplateGenerated: true
  },
  {
    id: "table-exit-interview",
    name: "Exit Interview",
    description: "A soft landing for the week.",
    maxMembers: 12,
    memberCount: 4,
    prompt: "Best thing that happened to you this week. Go.",
    suggestedTopics: ["Life", "Music", "Random"],
    isActive: true,
    energyLevel: "Warming up",
    hostPrompt: "Someone here has a story that starts with 'so we thought it was a good idea to...'",
    isTemplateGenerated: true
  },
  {
    id: "table-regulars",
    name: "The Regulars",
    description: "Local moves without the tourist brochure.",
    maxMembers: 12,
    memberCount: 3,
    prompt: "You clearly come here. What's the move after this?",
    suggestedTopics: ["Food", "Music", "Life"],
    isActive: true,
    energyLevel: "Quiet",
    hostPrompt: "Name one place you would actually defend.",
    isTemplateGenerated: true
  },
  {
    id: "table-lost-found",
    name: "Lost & Found",
    description: "Small confessions, no big performance.",
    maxMembers: 10,
    memberCount: 7,
    prompt: "Three things you've lost. One you found. Go.",
    suggestedTopics: ["Life", "Books", "Random"],
    isActive: true,
    energyLevel: "Active",
    hostPrompt: "What's the last thing that genuinely surprised you?",
    isTemplateGenerated: true
  }
];
