    ...
    <AppShell wide>
      <MotionShell className="grid gap-5 py-2">
        <VenueConsoleHeader
          ...
          summary="Print QR cards, safety copy, staff run sheet, and optional Signal coasters."
          ...
          <div className="grid gap-5">
            <CommandPanel>
              ...
              <p className="mt-2 text-sm leading-6 text-venue-muted">
                Seven venue-ready assets generated from the selected recipe. Guest-facing assets send people into Signal Night.
              </p>
              <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                ...
                <div className="rounded-[10px] bg-white/10 px-3 py-2"><p className="text-lg font-medium">1</p><p className="text-xs text-venue-muted">Signal sheet</p></div>
              </div>
            </CommandPanel>
            <ConsolePanel>
              <SectionLabel>Guest link</SectionLabel>
